* `src/`
    ...
    * `fst/`
        ...
        * `transcriptions/`
            ...
            * [transcriptor-symbols2text.lexc](src-fst-transcriptions-transcriptor-symbols2text.lexc.html) ([src](https://github.com/giellalt/lang-hil/blob/main/src/fst/transcriptions/transcriptor-symbols2text.lexc))
* `tools/`
    * `tokenisers/`
